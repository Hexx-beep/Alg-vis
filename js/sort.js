...
document.addEventListener('DOMContentLoaded', function() {
            // Add event listener for the header compare button
            document.getElementById('compare-btn').addEventListener('click', function() {
                window.location.href = 'sorting-comparison.html';
            });
            
            // Add event listener for the panel compare button
            document.getElementById('compare-panel-btn').addEventListener('click', function() {
                window.location.href = 'sorting-comparison.html';
            });
        });
